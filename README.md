...
### Example Message 
Here is an example of the message format as posted in Teams. If necessary, this format can be customized in the 'Parse JSON' step in the logic app. A example of a service health alert schema (using Common Alert Schema) can be found in this GitHub repo https://github.com/scautomation/Common-Alert-Schema/blob/master/serviceHealth/alert.json. 
